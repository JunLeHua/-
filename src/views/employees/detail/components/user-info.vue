...
import { getEmployeesInfo, getEmployeesBaseInfo, saveEmployeesBaseInfo } from '@/api/employees'
...
export default {
  ...
  methods: {
    ...
    // 获取员工基本信息
    async loadEmployeesBaseInfo () {
      this.userInfo = await getEmployeesBaseInfo(this.userId)
      this.$refs.uploadAvatar.fileList = [{ url: this.userInfo.staffPhoto }]
    },
    // 图片接收
    onSuccess1 (val) {
      // console.log(val)
